...
class Picture:
  ...
  def under(self, p):
    """ Devuelve una nueva figura poniendo la figura p sobre la
        figura actual """
    #Lista para almacenar las filas combinadas finales
    fusionado = []
    
    #Recorremos al mismo tiempo las filas del fondo (self) y del frente (p)
    for f_fondo, f_frente in zip(self.img, p.img):
        nueva_linea = []
        
        #Recorremos carácter por carácter de ambas filas alineadamente
        ...
        #Juntamos los caracteres en un string y lo agregamos a la lista
        fusionado.append("".join(nueva_linea))
        
    #Devolvemos el nuevo objeto Picture con el arreglo interno resultante
    return Picture(fusionado)
  
  def horizontalRepeat(self, n):
    """ Devuelve una nueva figura repitiendo la figura actual al costado
        la cantidad de veces que indique el valor de n """
    #Multiplicamos cada string (fila) de texto por n usando comprensión de listas
    repetido_horizontal = [fila * n for fila in self.img]
